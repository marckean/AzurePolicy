...
New-AzManagementGroupDeployment -Location $location -TemplateFile '.\TestEnvironment\main.bicep' -ManagementGroupId $ManagementGroupId -Verbose

# NSG with rules included - ONLY
New-AzManagementGroupDeployment -Location $location -TemplateFile '.\TestEnvironment\main(nsg).bicep' -ManagementGroupId $ManagementGroupId -Verbose
